...
🌐 Live Demo
Frontend: https://supply-pulse-ai-client.vercel.app
Backend API: https://supplypulseai.onrender.com
...
Selects relevant supply chain tools
Executes intelligence engines
Analyzes evidence
Generates grounded business recommendations
Flow:
User Question
      ↓
...
Controlled Tool Calling Layer
      ↓
Risk Engine · Inventory Engine · Forecast Engine
Supplier Engine · Recommendation Engine · Alert Engine
      ↓
...
Eid Sale
Flash Sales
brands often identify stockout risks too late. This leads to:
Lost revenue
...
SupplyPulse AI combines inventory signals from Amazon, Shopify, Meesho, and Flipkart, providing a unified view of inventory health across multiple marketplaces.
2. Gemini AI Supply Chain Copilot
The AI Copilot allows operations managers to ask natural language questions, for example:
...
Revenue at Risk: ₹99.0L

Immediate Action: Reorder Handbag Premium Pack
Supplier: Bengaluru Naturals
Revenue Protected: ₹6.7L
...
SupplyPulse AI converts risks into actions. The AI recommends:
Reorder quantity
Best supplier
Reorder deadline
Revenue impact
...
Marketplace Data (Amazon · Shopify · Meesho · Flipkart)
      ↓
...
Framework: Vite
Environment Variable: VITE_API_URL=https://supplypulseai.onrender.com
Backend Deployment
Platform: Render
