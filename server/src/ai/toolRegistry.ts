...
export const copilotToolRegistry: CopilotToolDefinition[] = [
  {
...
export const getCopilotToolDefinition = (name: CopilotToolName): CopilotToolDefinition | undefined =>
  copilotToolRegistry.find((tool) => tool.name === name);
