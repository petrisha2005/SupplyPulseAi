...
export interface ForecastResponse {
  ...
  channelDemandSplit?: Array<{ channel: Channel; sharePct: number; avgUnitsPerDay: number; trendPct: number }>;
  forecastExplanation?: {
    summary: string;
    trendReason: string;
    eventReason: string;
  ...
  channelDemand?: Array<{ channel: Channel; demand: number }>;
  revenueAtRiskSeries?: Array<{ date: string; revenueAtRisk: number }>;
}
...
export interface ExecutiveReportResponse {
  ...
  supplierSummary: {
    ...
    alternateSupplierSuggestions: Array<{ supplier: string; suggestion: string }>;
  };
